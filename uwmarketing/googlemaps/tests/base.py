...
def setup_product():
    ...
    zcml.load_config('configure.zcml', uwmarketing.googlemaps)
    ...
    # 
    #ztc.installPackage('.localrole')
    # 
    
    ztc.installPackage('uwmarketing.googlemaps')
...
setup_product()
ptc.setupPloneSite(products=['uwmarketing.googlemaps'])
